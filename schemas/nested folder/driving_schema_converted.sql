...
CREATE TABLE Staff_to_addresses AS EDGE;
CREATE TABLE Customers_to_addresses AS EDGE;
CREATE TABLE Customer_Payments_to_customers AS EDGE;
CREATE TABLE Lessons_to_vehicles AS EDGE;
CREATE TABLE Lessons_to_staff AS EDGE;
CREATE TABLE Lessons_to_customers AS EDGE;
